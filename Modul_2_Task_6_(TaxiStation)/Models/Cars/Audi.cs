...
namespace Modul_2_Task_6__TaxiStation_.Models.Cars
{
    ...
    {
        public Audi(CarBrand carBrand, string carModel, TypeOfEngine typeOfEngine, Color carColor, Country createdCountry, TypeOfBody typeOfBody, double cost, double fuelConsumed)
